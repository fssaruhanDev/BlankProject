...
public class IdentityService : IIdentityService
{
    public Task<LoginResponseModel> Login(LoginRequestModel requestModel)
    {
        ...
        var claims = new Claim[]
        {
                ...
                new Claim(ClaimTypes.Name, "Fatih Sultan Saruhan"),
        };

        var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("4c9TQdWbKx5eItAPn7JaFgmSfzBrGUXv1s6VYNhZlC8wHEO032"));
